...
class RouteConstants {
  ...
  /// route for page [BiodataPage]
  static const String biodata = 'biodata';
  static const String biodataPath = 'biodata';

  /// route for page [CheckoutPage]
  static const String addBiodataPage = 'add-biodata';
  static const String addBiodataPath = 'add-biodata';
