...
class _$UpdateProfileImpl implements _UpdateProfile {
  ...
  @override
  String toString() {
    return 'EditProfileEvent.updateProfile(name: $name, email: $email, phone: $phone, password: $password)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return updateProfile(name, email, phone, password);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return updateProfile?.call(name, email, phone, password);
  }
...
abstract class _UpdateProfile implements EditProfileEvent {
  const factory _UpdateProfile(
      ...
      required final String password}) = _$UpdateProfileImpl;
...
abstract class _Loaded implements EditProfileState {
  const factory _Loaded(final User profile) = _$LoadedImpl;
