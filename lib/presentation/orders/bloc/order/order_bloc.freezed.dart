...
mixin _$OrderEvent {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(int personalDataId, String paymentMethod,
            String paymentVaName, List<ProductQuantity> products)
        doOrder,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(int personalDataId, String paymentMethod,
            String paymentVaName, List<ProductQuantity> products)?
        doOrder,
  }) =>
      throw _privateConstructorUsedError;
...
class __$$DoOrderImplCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$DoOrderImpl(
      personalDataId: null == personalDataId
...
class _$DoOrderImpl implements _DoOrder {
  ...
  @override
  String toString() {
    return 'OrderEvent.doOrder(personalDataId: $personalDataId, paymentMethod: $paymentMethod, paymentVaName: $paymentVaName, products: $products)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, personalDataId, paymentMethod,
      paymentVaName, const DeepCollectionEquality().hash(_products));
  ...
  TResult when<TResult extends Object?>({
    ...
    return doOrder(personalDataId, paymentMethod, paymentVaName, products);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return doOrder?.call(
        personalDataId, paymentMethod, paymentVaName, products);
  }
...
abstract class _DoOrder implements OrderEvent {
  const factory _DoOrder(
      {required final int personalDataId,
